...
"[project]/src/app/api/frames/[type]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from(tableName).select('*');
    if (shape) {
...
async function POST(request, { params }) {
    ...
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from(tableName).insert([
            body
        ]).select().single();
        if (error) {
            console.error(error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1220feb3._.js.map