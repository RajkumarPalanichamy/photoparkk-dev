...
"[project]/src/app/api/specialoffers/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('special_offers').select('*').order('created_at', {
        ascending: false
    });
    if (error) {
...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('special_offers').insert([
            body
        ]).select().single();
        if (error) {
            console.error(error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5706d873._.js.map