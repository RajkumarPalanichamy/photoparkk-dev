...
"[project]/src/app/api/cart/user/[userId]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('cart_items').select('*').eq('user_id', userId);
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f3face49._.js.map