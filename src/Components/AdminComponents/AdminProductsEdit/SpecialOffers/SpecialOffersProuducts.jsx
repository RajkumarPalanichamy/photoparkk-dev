...
const SpecialOffersProducts = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axiosInstance.delete(`/specialoffers/${id}`);
  ...
  const filteredProducts = specialoffersItems.filter((item) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
        ...
        <Link href="/admin/specialoffersaddform">
      ...
      <div className="mb-4 text-sm text-neutral-600">
        Showing {filteredProducts.length} of {specialoffersItems.length}{" "}
        products
      </div>
              ...
              >
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto flex gap-2">
                    <Link
                      href={`/admin/specialoffersupdateform/${item._id}`}
                      className="flex-1"
                    >
