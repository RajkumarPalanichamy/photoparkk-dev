                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            {...register("user_name")}
                                            className={`w-full px-4 py-3 bg-white border rounded-2xl focus:outline-none focus:ring-2 transition-all duration-300 ${errors.user_name
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            {...register("user_email")}
                                            className={`w-full px-4 py-3 bg-white border rounded-2xl focus:outline-none focus:ring-2 transition-all duration-300 ${errors.user_email
                                                ? "border-error focus:ring-red-500"
                                                : "border-neutral-200 focus:ring-primary-light focus:border-transparent"
                                                }`}
                                        />
                                    ...
                                    >
                                        ...
                                        <textarea
                                            ...
                                            maxLength={2000}
                                            {...register("message")}
                                            className={`w-full px-4 py-3 bg-white border rounded-2xl focus:outline-none focus:ring-2 transition-all duration-300 resize-none ${errors.message
                                                ? "border-error focus:ring-red-500"
                                                : "border-neutral-200 focus:ring-primary-light focus:border-transparent"
                                                }`}
                                        />
                                        <div className="flex justify-between items-center mt-1">
                                            ...
                                            <span
                                                className={`text-xs ${messageLength > 2000
                                                    ? "text-red-500"
                                                    : messageLength > 1800
                                                        ? "text-warning"
                                                        : "text-neutral-500"
