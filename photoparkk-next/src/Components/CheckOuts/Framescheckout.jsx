  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      if (paymentMethod === "COD") {
        ...
        await axiosInstance.post('frameorders', orderPayload);
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200">
          ...
          <form onSubmit={handlePayment} className="space-y-4">
            ...
            <button
              ...
              className={`w-full py-3 rounded-lg shadow-sm transition-colors ${paymentLoading ? "bg-neutral-300 text-neutral-700" : "bg-primary hover:bg-primary-hover text-white"
                }`}
            >
