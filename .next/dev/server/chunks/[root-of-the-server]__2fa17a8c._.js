...
"[project]/src/app/api/customizer-templates/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('customizer_templates').update(body).eq('id', id).select().single();
        if (error) {
...
async function DELETE(request, { params }) {
    const { id } = await params;
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('customizer_templates').delete().eq('id', id);
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2fa17a8c._.js.map